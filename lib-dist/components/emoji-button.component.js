...
EmojiButtonComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [":host{display:inline-block}.emoji-button{padding:0;outline:0;background:0 0;width:34px;height:34px;border:5px solid transparent;border-radius:3px;font-size:24px;line-height:1.1;cursor:pointer;transition:all .2s}.emoji-button:focus,.emoji-button:hover{background:#f1f1f1;border-color:#f1f1f1}"],
